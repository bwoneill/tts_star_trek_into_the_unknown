...
local shipClass = getObjectFromGUID("4f3648")
local alertToken = getObjectFromGUID("e30753")
local powerToken = getObjectFromGUID("f5bb7f")
local healthToken = getObjectFromGUID("b21c74")
local crewToken = getObjectFromGUID("38d090")

function setUp()

	local shipBag = getObjectFromGUID("d38d92").clone()
