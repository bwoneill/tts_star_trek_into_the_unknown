...
saucerSize = Global.getTable("shipSize").medium
...
local shipClass = getObjectFromGUID("2d1800")
...
local crewToken = getObjectFromGUID("1f48b5")
local shipClassAlt1 = getObjectFromGUID("e84ddc")
local shipClassAlt2 = getObjectFromGUID("e84ddc")

function setUp()

    local shipBag = getObjectFromGUID("1a3921").clone()
	...
	self.UI.setAttribute("detachBtn", "active", "true")
