...
local shipClass = getObjectFromGUID("8ae071")
...
function setUp()
    ...
    myShip = getObjectFromGUID("8ae071").clone()
...
function scanCheck()
    ...
    if arc_drawn then
        ...
        local desired_arc_distance_cir = front_edge_distance + _rangeCir - 0.35
        local desired_arc_distance_front = front_edge_distance + _range - 0.35
